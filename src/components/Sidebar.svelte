                    ...
                    <ul class="mt-12">
                        <li class="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm  ml-2">Dashboard</span></div>
                        ...
                        <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm  ml-2">Products</span></div>
                        ...
                        <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm  ml-2">Performance</span></div>
                        </li>
                        <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm  ml-2">Deliverables</span></div>
                        </li>
                        <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-puzzle" width="18" height="18" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <span class="text-sm  ml-2">Invoices</span></div>
                        ...
                        <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm  ml-2">Inventory</span></div>
                        </li>
                        <li class="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm  ml-2">Settings</span></div>
                        </li>
                    </ul>
